...
require (
	github.com/DataDog/agent-payload/v5 v5.0.150-0.20250508143226-2944c0892459
	...
	github.com/DataDog/test-infra-definitions v0.0.0-20250506103533-fa71308022b9
